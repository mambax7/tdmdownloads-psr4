...
//Configurator
return (object)[
    'name'          => strtoupper($moduleDirName) . ' TdmDownloads Module Configurator',
    'paths'         => [
    ...
    'uploadFolders' => [
        ...
        constant($capsDirName . '_UPLOAD_PATH') . '/downloads',
        constant($capsDirName . '_UPLOAD_PATH') . '/images',
        constant($capsDirName . '_UPLOAD_PATH') . '/images/cats',
        constant($capsDirName . '_UPLOAD_PATH') . '/images/field',
        constant($capsDirName . '_UPLOAD_PATH') . '/images/shots',
    ],
    'blankFiles'    => [
        constant($capsDirName . '_UPLOAD_PATH'),
        constant($capsDirName . '_UPLOAD_PATH') . '/downloads',
    ...
    'copyFolders'   => [
        ['source' => XOOPS_ROOT_PATH . '/modules/' . $moduleDirName . '/extra/uploads' . '/' . $moduleDirName, 'dest' => constant($capsDirName . '_UPLOAD_PATH')],
