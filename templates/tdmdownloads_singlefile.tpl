        ...
        <div class="itemBody">
            ...
            <div class="tdmdownloads-downInfo <{$infofloat}>">
                ...
                <{if $sup_aff == true}>
                    <div class="tdmdownloads-box" id="tdmdownloads-box-2">
                        <{foreach item=champ from=$champ_sup}>
                            <div class="champ"
                                 style="background: url(<{$champ.image}>) no-repeat left;"><{$champ.data}></div>
                        <{/foreach}>
                    </div>
                <{/if}>
                <div class="tdmdownloads-box" id="tdmdownloads-box-3">
                    <{if $perm_vote != ""}>
                        <div id="torate">
                            <a href="<{$xoops_url}>/modules/<{$mydirname}>/ratefile.php?lid=<{$lid}>"
                               title="<{$smarty.const._MD_TDMDOWNLOADS_SINGLEFILE_RATHFILE}>"><{$smarty.const._MD_TDMDOWNLOADS_SINGLEFILE_RATHFILE}></a>
                        </div>
                    <{/if}>
                    <{if $perm_modif != ""}>
                        <div id="tomodify">
                            <a href="<{$xoops_url}>/modules/<{$mydirname}>/modfile.php?lid=<{$lid}>"
                               title="<{$smarty.const._MD_TDMDOWNLOADS_SINGLEFILE_MODIFY}>"><{$smarty.const._MD_TDMDOWNLOADS_SINGLEFILE_MODIFY}></a>
                        </div>
                    <{/if}>
                    <div id="toreport">
                        <a href="<{$xoops_url}>/modules/<{$mydirname}>/brokenfile.php?lid=<{$lid}>"
                ...
                <{if $perm_download != ""}>
                    <div class="tdmdownloads-box" id="tdmdownloads-box-4">
                        <div id="download">
                            <a href="<{$xoops_url}>/modules/<{$mydirname}>/visit.php?cid=<{$cid}>&amp;lid=<{$lid}>"
                               rel="directory nofollow external"><{$smarty.const._MD_TDMDOWNLOADS_INDEX_DLNOW}></a>
                        </div>
                    </div>
                <{else}>
            ...
            <ul>
                <li>
                    <div class="facebook">
                        ...
                        <fb:like href="<{$xoops_url}>/modules/<{$mydirname}>/singlefile.php?lid=<{$lid}>"
                                 layout="button_count"
                ...
                <li>
                    <div class="twitter">
                        ...
                        <a href="http://twitter.com/share/<{$xoops_url}>/modules/<{$mydirname}>/singlefile.php?lid=<{$lid}>"
            ...
            <div class="tdmdownloads-bookmarkmeitems">
                ...
                <a rel="nofollow external" title="<{$smarty.const._MD_TDMDOWNLOADS_BOOKMARK_TO_BALATARIN}>"
                   href="http://balatarin.com/links/submit?phase=2&amp;url=<{$xoops_url}>/modules/<{$mydirname}>/singlefile.php?lid=<{$lid}>"><img
                            ...
                            src="<{$xoops_url}>/modules/<{$mydirname}>/assets/images/bookmarks/balatarin.png"></a>
