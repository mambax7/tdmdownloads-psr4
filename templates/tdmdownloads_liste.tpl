    ...
    <table width="100%" cellspacing="0" class="outer_sertec" border="1">
        <tr>
            ...
            <td class="head" align="left"
                style="vertical-align: middle;"><{$smarty.const._MD_TDMDOWNLOADS_SEARCH_TITLE}></td>
            <td class="head" align="left" style="width: 150px; vertical-align: middle;" colspan="2">
                <{$smarty.const._MD_TDMDOWNLOADS_SEARCH_CATEGORIES}>
            </td>
            <{foreach item=field from=$field}>
                <td class="head" align="left" style="vertical-align: middle;"><{$field}></td>
            <{/foreach}>
            <td class="head" align="center"
                style="width: 100px; vertical-align: middle;"><{$smarty.const._MD_TDMDOWNLOADS_SEARCH_DATE}></td>
            <td class="head" align="center"
                style="width: 60px; vertical-align: middle;"><{$smarty.const._MD_TDMDOWNLOADS_SEARCH_NOTE}></td>
            <td class="head" align="center"
                style="width: 60px; vertical-align: middle;"><{$smarty.const._MD_TDMDOWNLOADS_SEARCH_HITS}></td>
        </tr>
        <{foreach item=downloads from=$downloads}>
            <{cycle values="odd,even" assign=class}>
            <tr class="<{$class}>">
                <td align="center" style="vertical-align: middle;"><a
                            href="<{$xoops_url}>/modules/<{$mydirname}>/visit.php?cid=<{$downloads.cid}>&amp;lid=<{$downloads.lid}>"
                            target="_blank"><img
                ...
                <td align="left" style="vertical-align: middle;"><a
                            ...
                            title="<{$downloads.title}>"><{$downloads.title}></a></td>
