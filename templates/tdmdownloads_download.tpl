<div class="item tdmdownloads-item">
    <div class="itemHead">
        <span class="itemTitle">
            <strong><a title="<{$down.title}>"
                       href="<{$xoops_url}>/modules/<{$mydirname}>/singlefile.php?cid=<{$down.cid}>&amp;lid=<{$down.id}>"
                       rel="directory"><{$down.title}></a></strong>
        </span>
        <b>
    </div>
    <div class="itemInfo">
    ...
    <div class="itemBody">
        ...
        <{if $down.perm_download != ""}>
            <span class="itemDownload"><a title="<{$smarty.const._MD_TDMDOWNLOADS_INDEX_DLNOW}>"
    ...
    <div class="itemFoot">
        ...
        <span class="itemPermaLink"><a title="<{$down.title}>"
                                       href="<{$xoops_url}>/modules/<{$mydirname}>/singlefile.php?cid=<{$down.cid}>&amp;lid=<{$down.id}>"
                                       rel="directory"><{$smarty.const._MD_TDMDOWNLOADS_MOREDETAILS}></a></span>
