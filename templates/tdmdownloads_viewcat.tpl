                ...
                <td>
                    <div class="tdmdownloads-data">
                        <div class="tdmdownloads-title">
                            <div class="floatleft title"><h2><a title="<{$category.title}>"
                                                                href="<{$xoops_url}>/modules/<{$mydirname}>/viewcat.php?cid=<{$category.id}>"><{$category.title}></a>
                                </h2></div>
                            <div class="floatright total xo-pagact"><a title="<{$category.title}>"
                                                                       href="<{$xoops_url}>/modules/<{$mydirname}>/viewcat.php?cid=<{$category.id}>"><{$category.totaldownloads}></a>
                            </div>
                        ...
                        <div class="mrag2 pad2">
                            <ul>
                                <{foreach item=bl_date from=$bl_date}>
                                    <li><a title="<{$bl_date.title}>"
                                           href="<{$xoops_url}>/modules/<{$mydirname}>/singlefile.php?cid=<{$bl_date.cid}>&amp;lid=<{$bl_date.id}>"><{$bl_date.title}></a>
                                        (<{$bl_date.date}>)
                                    </li>
                                <{/foreach}>
                            </ul>
                        ...
                        <div class="mrag2 pad2">
                            <ul>
                                <{foreach item=bl_pop from=$bl_pop}>
                                    <li><a title="<{$bl_pop.title}>"
                                           href="<{$xoops_url}>/modules/<{$mydirname}>/singlefile.php?cid=<{$bl_pop.cid}>&amp;lid=<{$bl_pop.id}>"><{$bl_pop.title}></a>
                                        (<{$bl_pop.hits}>)
                                    </li>
                                <{/foreach}>
                            </ul>
                        ...
                        <div class="mrag2 pad2">
                            <ul>
                                <{foreach item=bl_rating from=$bl_rating}>
                                    <li><a title="<{$bl_rating.title}>"
                                           href="<{$xoops_url}>/modules/<{$mydirname}>/singlefile.php?cid=<{$bl_rating.cid}>&amp;lid=<{$bl_rating.id}>"><{$bl_rating.title}></a>
                                        (<{$bl_rating.rating}>)
                                    </li>
                                <{/foreach}>
                            </ul>
